...
const TCP = require('../node_modules/libp2p-tcp') //trasporto
const SECIO = require('../node_modules/libp2p-secio') //crittografia della connessione
const MPLEX = require('../node_modules/libp2p-mplex') //stream multiplexing per gestire più comunicazioni
const multiaddr = require('../node_modules/multiaddr') //gestione indirizzo del nodo
